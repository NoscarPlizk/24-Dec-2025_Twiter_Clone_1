  ...
  return (
    <Row>
      ...
      <Col md={6}>
        ...
        <p className="mt-5" stysle={{ fontSize: 64 }}>Happening Now</p>
          ...
          <Modal.Body>
            ...
            >
              ...
              <p style={{ fontSize: "12px" }}>
                ...
                including Cookie Use. SigmaTweets may use your contact infomation, 
                including your email address and phone number for purposes outlined in our Privacy Policy, 
                like keeping your account secure and personalising our services, including ads. Learn more. 
                Others will be alble to find you by email or phone number, when provided, unless you choose otherwise here.
              </p>
